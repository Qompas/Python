...
class Cell:
    ...
    def __sub__(self, other):
        if self.number != other.number:
            return Cell(abs(self.number - other.number))
        print("Ошибка! Вычитание одинаковых клеток")
    ...
    def make_order(self, cells_in_a_row):
        string = ""
        rows = self.number // cells_in_a_row
        for i in range(rows):
            string += "*" * cells_in_a_row + "\n"
        string += "*" * (self.number - cells_in_a_row * rows)
        if self.number - cells_in_a_row * rows == 0:
            string = string[:-1]
        return string
...
cell_6 = (cell_3 - cell_1) * cell_2
print(cell_6.make_order(2))

cell_7 = cell_1 / cell_2
print(cell_7.make_order(2))
